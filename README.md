...
2. ที่คั่นด้วยวัน `createdDate` format yyyy-MM-ddd เพื่อเอาไว้ sort ด้วยวันที่ หรือเอาไว้ลบ กรณีเป็น temp และ file นั้น expire ไปแล้ว  จะได้เช็คง่ายๆ 
  
3. ต่อมา `uuid` เพื่อการันตีความ unique 

4. ที่ตั้งชื่อ file เป็น `file` เพราะไม่อยากให้เกิดปัญหาชื่อไฟล์ภาษาไทย หรืออัขระพิเศษบางตัว ที่อาจทำให้ไฟล์เสียหาย  ซึ่งถ้าอยากได้ชื่อไฟล์จริงๆ ที่ upload มาให้ไปเอาที่ database (file display name)  
